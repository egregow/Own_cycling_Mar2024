...
v[3] =['ALL','METCOOP'] ;
t[3] = v[3] ;
v[4] = ['FF','GX','TT','TTHA','RH','NN','CH','LC','PE1','PE3','PE6','PE12','VI']
t[4] = ['U10m','Max Wind Gust','T2m','T2m, height corr.','Rh2m','Cloud cover','Cloud base','Low clouds','1h Precipitation','3h Precipitation','6h Precipitation','12h Precipitation','Visibility']
v[5] =[0]
v[5] =v[5].reverse()
t[5] =v[5]
